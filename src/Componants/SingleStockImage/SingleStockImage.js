          ...
          <Flex mt={"5"} alignItems={"center"} justifyContent={"center"}>
            <Button bg={"white"} border={"1px solid #FE94A2"} rounded={"full"}>
              ...
              <Flex alignItems={"center"}>
                <Image me={"1"} w={"40px"} src={wishlist} /> wish list{" "}
              </Flex>
            </Button>
            ...
            >
              <GridItem>
                <Text fontWeight={"semibold"}>
                  Ukrine flag large national symbol fultteing in blue sky,large
                  yellow blue ukrinean state flag,Dnipro city,independence.
                </Text>
                ...
                <Text fontWeight={"light"} mt={"2"} fontSize={"14px"}>
                  Our press team loves working with journerlist the world to
                  store compeling,unique stories if you are member <br /> of the
                  media and woud like to talk place get in touch
                </Text>
              </GridItem>
              ...
              <GridItem>
                ...
                <Flex alignItems={"center"} mt={"2"}>
                  ...
                  <Text fontWeight={"semibold"} ms={"3"} fontSize={"12px"}>
                    {" "}
                    Kayes Fahim
                  </Text>
                </Flex>
