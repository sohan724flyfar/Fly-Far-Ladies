        ...
        <Box border={'1px solid #FE94A2'} bg={'white'} mt={'20'} >
            ...
            <Box mt={'2'} borderBottom={'1px solid #FE94A2'}>
                ...
                <Flex mt={'3'} justifyContent={'space-between'}>
                    <Text ms={'5'} fontSize={'12px'} color={'#FE94A2'}>Discount:0</Text>
            ...
            <Flex mt={'3'} justifyContent={'space-between'} alignItems={'center'} px={'5'}>
                ...
                <Flex alignItems={'center'} ms={'20'}>
                    ...
                    <Button _focus={{ 'outline': 'none', }} _hover={{ 'border': '1px', 'bgColor': 'white', 'borderColor': '#FE94A2', 'color': '#FE94A2' }} border={'1px solid transparent'} bgColor={'#FE94A2'} color={'white'} borderRadius={'none'}>Apply</Button>
                </Flex>
            </Flex>

            <Flex mt={'3'} px={'5'} pb={'1'}>
                <Box>
                    <Text fontSize={'12px'} color={'#FE94A2'}>Vat 10% (lean Detail)</Text>
                    <Text mt={'1'} fontSize={'12px'} color={'#FE94A2'}>Tax 10% (lean Detail)</Text>
                </Box>
            </Flex>
