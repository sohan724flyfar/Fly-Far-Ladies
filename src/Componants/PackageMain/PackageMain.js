...
import adventure from "../../images/adventurer.webp";
import location from "../../images/strength.webp";
...
const PackageMain = () => {
  ...
  useEffect(() => {
    fetch("https://api.flyfarladies.com/package/packagelist.php")
  ...
  return (
    <Box>
      ...
      <Box className={"mainpackagebg"}>
        {/* best tour package headline start */}
        <Container maxW={"container.xl"} textAlign={"center"} pt={"20"}>
          <Text fontSize={"4xl"} fontWeight={"bold"}>
            Best Tour Package
          </Text>
          <Text mt={"3"}>
            You can find the best pakage from here and select it and travel{" "}
            <br /> around the wrold!
          </Text>
        ...
        <Container maxW={"container.xl"} mt={"20"}>
          <Grid templateColumns={"3fr 9fr"} gap={"10"}>
            ...
            <GridItem>
              ...
              {/* <FullPackage bg={"white"} img={PhotosOne} /> */}
            </GridItem>
          </Grid>
        </Container>
        {/* main package end */}
