...
const StockImageMain = (props) => {
    return (
        <Box position={'relative'} overflow="hidden" border={'1px'} borderColor={'transparent'} borderRadius={'xl'} role="group">
            <Image _hover={{ transform: "scale(1.1)", transition: "all 400ms ease", filter: "grayscale(0.5)" }} borderRadius={'md'} w={'100%'} h={'250px'} cursor={'pointer'} src={props.img}></Image>
            ...
            <Box position={'absolute'} _groupHover={{ bottom: "6px", left: "6px", top: "5px" }}>
