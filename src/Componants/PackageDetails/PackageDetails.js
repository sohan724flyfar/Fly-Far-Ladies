...
import location from "../../images/location-accordian.webp";
import description from "../../images/description.webp";
import timing from "../../images/timing.webp";
import inclusion from "../../images/inclusion.webp";
import addition from "../../images/additional.webp";
    ...
    <Box>
      ...
      <Box className={"allpackagebg"}>
          ...
          <Grid templateColumns={"3fr 9fr"} gap={"10"}>
            ...
            <GridItem>
              <Text fontSize={"2xl"} fontWeight={"semibold"}>
                Haritage Resort- Daylong package
              </Text>
                  ...
                  <Grid templateColumns={"8fr 4fr"} gap={10}>
                    ...
                    <GridItem>
                      ...
                      >
                        ...
                        <Box mt={"2"}>
                          <Flex fontSize={"15px"}>
                            You Can Book With Minimum Amount{" "}
                            <Text
                              ms={"1"}
                              color={"#FE94A2"}
                              fontWeight={"semibold"}
        ...
        <Container maxWidth={"container.xl"} mt={"20"} pb={"20"}>
          <Flex fontSize={"35px"} fontWeight={"semibold"}>
            You May{" "}
            <Text ms={"2"} color={"#FE94A2"}>
              Like Also
            </Text>
          </Flex>
